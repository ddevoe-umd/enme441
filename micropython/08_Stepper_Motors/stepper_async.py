...
# ---------------------------
#
# 1. The ESP32-C3 is a SINGLE-CORE RISC-V chip. (Some ESP32s are
#    dual-core; the C3 is not.) _thread therefore buys zero
...
#
# 2. Step timing is open-loop: we write 4 pins, wait a fixed interval,
