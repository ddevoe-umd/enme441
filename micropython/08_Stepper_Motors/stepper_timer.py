...
#                 the moves.
#
# Port of the Raspberry Pi / RPi.GPIO / multiprocessing version (stepper.py).
# Drives any number of 28BYJ-48 steppers (ULN2003 driver) at the same time.
# =============================================================================
#
...
# one resumes. So the step period is neither the 1200 us of the original nor
# even constant: it drifts upward as you add motors.
#
...
#
# ONE HONEST CAVEAT ABOUT "ISR" ON THE ESP32 PORT
# -----------------------------------------------
